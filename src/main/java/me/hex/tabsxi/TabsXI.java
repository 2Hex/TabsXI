...
public final class TabsXI extends JavaPlugin {
    ...
    ArrayList<Character> alphabet = new ArrayList<>(myString.chars().mapToObj(c -> (char) c).collect(Collectors.toList()));
    ...
    public void onEnable() {
        ...
        for (char letter = 'a'; letter <= 'z'; letter++) {
            ...
            System.out.println(letter + " TEAM CREATED");
            if (scoreboard.getTeam(String.valueOf(letter)) == null) {
                System.out.println("HOW IS IT NULL  JUST MADE IT");
            }
            ...
            scoreboard.getTeam(String.valueOf(letter)).setPrefix(cols.get(alphabet.indexOf(letter)));
        }
    ...
    public void teamColor(String team) {
        scoreboard.getTeam(team).setPrefix(ChatColor.translateAlternateColorCodes('&', cols.get(alphabet.indexOf(team.toCharArray()[0]))));
    }
